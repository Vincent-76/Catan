...
object JsonFileIO extends FileIO( "JSON", "json" ) {
  ...
  implicit class JsonTuple2[T1, T2]( tuple:(T1, T2) ) {
    def toJson( implicit fjs:Writes[T1], fjs2:Writes[T2] ):JsValue =
  ...
  implicit class JsonTuple3[T1, T2, T3]( tuple:(T1, T2, T3) ) {
    def toJson( implicit fjs:Writes[T1], fjs2:Writes[T2], fjs3:Writes[T3] ):JsValue =
  ...
  implicit class JsonValue( json:JsValue ) {
    def asOption[E]( implicit fjs:Reads[E] ):Option[E] = asOptionC( _.as[E] )
    ...
    def asTuple[T1, T2]( implicit fjs:Reads[T1], fjs2:Reads[T2] ):(T1, T2) = asTupleC( _.as[T1], _.as[T2] )
    ...
    def asTuple[T1, T2, T3]( implicit fjs:Reads[T1], fjs2:Reads[T2], fjs3:Reads[T3] ):(T1, T2, T3) = asTupleC( _.as[T1], _.as[T2], _.as[T3] )
  ...
  implicit class JsonLookupResult( jsonRes:JsLookupResult ) {
    ...
    def asList[E]( implicit fjs:Reads[E] ):List[E] = jsonRes.get.asList[E]
