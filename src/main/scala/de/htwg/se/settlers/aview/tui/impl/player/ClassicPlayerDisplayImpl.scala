package de.htwg.se.settlers.aview.tui.impl.player

import de.htwg.se.settlers.aview.tui.{ PlayerDisplay, TUI }
import de.htwg.se.settlers.model.Cards._
import de.htwg.se.settlers.model.impl.player.ClassicPlayerImpl
import de.htwg.se.settlers.model.{ Cards, Game, Resources }
